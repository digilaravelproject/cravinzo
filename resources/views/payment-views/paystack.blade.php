...
@push('script')
    <link rel="stylesheet" href="{{ dynamicAsset('public/assets/admin/paystack/css/paystack.css')}}">
...
@section('content')
    ...
    @push('script_2')
        <script src="{{ dynamicAsset('public/assets/admin/paystack/js/paystack.js')}}"></script>
    @endpush
