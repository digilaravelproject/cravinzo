                                ...
                                <div class="form-group">
                                    ...
                                    <select name="zone_id" class="form-control js-select2-custom" required
                                        ...
                                        <option value="" readonly="true"
                                                hidden="true">{{ translate('messages.select_zone') }}</option>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select name="identity_type" class="form-control">
                                        ...
                                        <option
                                            value="driving_license">{{ translate('messages.driving_license') }}</option>
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="form-group">
                                                    <label class="form-label"
                                                        ...
                                                        <small
                                                            class="text-danger {{$item['is_required']  == 1?'':'d-none'}}">*</small></label>
                                                    <input id="{{ $item['input_data'] }}"
                                                           {{ $item['is_required']  == 1? 'required' : '' }} type="{{ $item['field_type'] }}"
                                        ...
                                        @elseif ($item['field_type'] == 'file' )
                                            @if ($item['media_data'] != null)
                                                ...
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
                                                        <label class="form-label"
                                                               for="{{ $item['input_data'] }}">{{translate($item['input_data'])  }}<small
                                                                class="text-danger {{$item['is_required']  == 1?'':'d-none'}}">*</small></label>
                                                        <input id="{{ $item['input_data'] }}"
                                                               {{ $item['is_required']  == 1? 'required' : '' }} type="{{ $item['field_type'] }}"
