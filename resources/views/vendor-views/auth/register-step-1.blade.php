        ...
        function initMap() {
            ...
            searchBox.addListener("places_changed", () => {
                ...
                places.forEach((place) => {
                    ...
                    if (zonePolygon && !google.maps.geometry.poly.containsLocation(location, zonePolygon)) {
                        toastr.error("Please select a location inside the selected zone.", {
                            CloseButton: true,
                            ProgressBar: true
                        });

                        // ❌ Do not zoom/center, do not set lat/lng
                        return;
                    }
                    ...
                    // ✅ Fit bounds only for valid points
        ...
        $('#choice_zones').on('change', function() {
            ...
            $.get({
                ...
                success: function(data) {
                    ...
                    // ✅ Map Click Event Validation
                    google.maps.event.addListener(zonePolygon, 'click', function(mapsMouseEvent) {
                        const clickedLocation = mapsMouseEvent.latLng;

                        // Check if point inside zone
                        if (!google.maps.geometry.poly.containsLocation(clickedLocation, zonePolygon)) {
                            toastr.error("Please select a point inside the selected zone.", {
                                CloseButton: true,
                                ProgressBar: true
                            });
                            return;
                        ...
                        infoWindow = new google.maps.InfoWindow({
                            ...
                            content: JSON.stringify(clickedLocation.toJSON(), null, 2),
                        });
