                                    ...
                                    <div>
                                        ...
                                        <div class="upload-file d-flex image-230 mx-auto">
                                            <input type="file" name="image" class="upload-file__input single_file_input"
                                                    accept="{{IMAGE_EXTENSION}}" {{ $available_zone_image ? '' : 'required' }}>
                                        ...
                                        <p class="fs-10 text-center mb-0 mt-lg-4 mt-3">
                                            {{ translate(IMAGE_FORMAT.' Less Than 2MB')}} <span class="font-medium text-title">{{ translate('(590  x 232 px)')}}</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
