                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="resturant-type-group border bg-white">
                                            ...
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="offline_payment" name="partial_payment_method" {{ $partial_payment_method ? ($partial_payment_method->value == 'offline_payment' ? 'checked' : '') : '' }}>
                                                <span class="form-check-label">
