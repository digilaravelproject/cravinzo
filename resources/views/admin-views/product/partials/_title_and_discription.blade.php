               ...
               <div class="card-body">
                   <div class="lang_form" id="default-form">
                       ...
                       <div class="form-group mb-0 des_wrapper">
                           ...
                           <div class="outline-wrapper">
                                <textarea type="text" name="description[]" maxlength="600" data-maxlength="600" id="description-default" class="form-control ckeditor min-height-154px">{{ $product?->getRawOriginal('description') ?? old('description.0') }}</textarea>
