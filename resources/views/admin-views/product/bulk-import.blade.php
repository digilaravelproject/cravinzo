                                ...
                                <div class="mw-100">
                                    ...
                                    <div class="image-box banner">
                                        <label for="upload_excel"
                                            ...
                                            <img width="54" class="upload-icon"
                                                 src="{{dynamicAsset('public/assets/admin/img/excel-upload.png')}}"
                                                 alt="Upload Icon">
                                            <span
                                                class="upload-text px-2 filename text-center">{{ translate('Must be Excel files using our Excel template above')}}</span>
                                        </label>

                                        <input type="file" data-max-size="2" id="upload_excel" class="file_validation"
                                               name="upload_excel" accept=".xls, .xlsx" hidden>
                                    </div>
                                </div>
                            </div>
                        </div>
