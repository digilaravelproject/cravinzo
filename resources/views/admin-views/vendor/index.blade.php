                                    ...
                                    <div class="">
                                            ...
                                            <div class="pb-md-5">
                                                ...
                                                <div class="text-center">
                                                    <div class="upload-file mx-auto">
                                                        <input type="file" name="logo" id="image-input" class="upload-file__input single_file_input"
                                        ...
                                        <div class="p-xxl-20 p-12 global-bg-box rounded mb-20">
                                            <div class="pb-md-5">
                                                ...
                                                <div class="text-center">
                                                    <div class="upload-file mx-auto">
                                                        <input type="file" name="cover_photo" id="image-input2" class="upload-file__input single_file_input"
                                                                accept=".webp, .jpg, .jpeg, .png, .gif" required>
                                                        <label class="upload-file__wrapper ratio-3-1 max-w-300px w-300 mx-auto m-0">
                                                            <div class="upload-file-textbox text-center" style="">
                                                                <img width="22" class="svg" src="{{dynamicAsset('public/assets/admin/img/image-upload.png')}}" alt="img">
                                                                <h6 class="mt-1 text-gray1 fw-medium fs-10 lh-base text-center">
                                                                    <span class="text-info">{{translate('Click to upload')}}</span>
            ...
            <div class="card">
                ...
                <div class="card-body p-3">
                    <div class="row g-2">
                                ...
                                <div class="bg-light rounded p-space-0 bg-clr-none p-md-3">
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            ...
                                            <label class="mb-2 fs-14 text-dark" for="time">{{ translate('Estimated Delivery Time ( Min & Maximum Time )') }}<span class="text-danger">*</span></label>
                        ...
                        <div class="col-lg-12">
                            <div class="shadow-sm mt-sm-0 mt-2">
                                <!-- <div class="card-header">
                                    <h4 class="card-title m-0 d-flex align-items-center"> <span class="card-header-icon mr-2"><i class="tio-user"></i></span> <span></span></h4>
                                </div> -->
