                                            ...
                                            <div class="d-flex flex-wrap gap-4 align-items-start">
                                                @foreach ($additional_docs as $key => $item)
                                                    ...
                                                    @foreach ($item as $file)
                                                        ...
                                                        @php($path_info = pathinfo(\App\CentralLogics\Helpers::get_full_url('additional_documents', $file['file'], $file['storage'])))
                                                        @php($ext = strtolower($path_info['extension'] ?? ''))
                                                        ...
                                                        @if (in_array($ext, ['pdf', 'doc', 'docx', 'docs']))
                                                            <div class="attachment-card min-w-260">
                                                                ...
                                                                <a href="{{ \App\CentralLogics\Helpers::get_full_url('additional_documents',$file['file'],$file['storage']) }}" download class="download-icon mt-3">
                                                                    <img src="{{ dynamicAsset('/public/assets/admin/new-img/download-icon.svg') }}" alt="">
                                                                </a>
                                                                <a href="#" class="pdf-info">
                                                                    <img src="{{ dynamicAsset('/public/assets/admin/new-img/' . ($ext == 'pdf' ? 'pdf.png' : 'doc.png')) }}" alt="">
                                                                    <div class="w-0 flex-grow-1">
                                                                        <h6 class="title">{{ translate('Click_To_View_The_file.' . $ext) }}</h6>
                                                                    </div>
                                                                </a>
                                                            </div>
                                                        @endif
                                                    ...
                                                    @foreach ($item as $file)
                                                        ...
                                                        @if (in_array($ext, ['jpg', 'jpeg', 'png']))
                                                            <div class="attachment-card max-w-360">
                                                                ...
                                                                <img src="{{ \App\CentralLogics\Helpers::get_full_url('additional_documents',$file['file'],$file['storage']) }}" class="aspect-615-350 cursor-pointer mw-100 object--cover" alt="">
                                                            </div>
                                                        @endif
                                                    @endforeach
                                                @endforeach
