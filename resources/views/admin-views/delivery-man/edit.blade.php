                                    ...
                                    <div class="text-center">
                                        <div class="upload-file mx-auto">
                                            <input type="file" name="image" class="upload-file__input single_file_input"
                                                    accept=".webp, .jpg, .jpeg, .png, .gif" @if(!$delivery_man?->image) required @endif>
                                            <label class="upload-file__wrapper ratio-1 h-140px mx-auto m-0">
                                                ...
                                                <img class="upload-file-img" loading="lazy" src="{{ $delivery_man['image_full_url'] }}" data-default-src="{{ $delivery_man['image_full_url'] }}" alt="" style="display: none;">
                                            </label>
                                            <div class="overlay">
